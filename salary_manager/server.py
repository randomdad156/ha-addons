...
Serves the single-page app and stores its data in /data/salary-manager-data.json
...
DATA_DIR = "/data"
DATA_FILE = os.path.join(DATA_DIR, "salary-manager-data.json")
...
def write_data(body):
    with _lock:
        ...
        try:
            ...
            with open(os.path.join(BACKUP_DIR, "salary-manager-%s.json" % day), "wb") as f:
                f.write(body)
